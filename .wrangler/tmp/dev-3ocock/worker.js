...
// .wrangler/tmp/bundle-r5zoOa/checked-fetch.js
      ...
      if (path.startsWith("/api/cloudflare/analytics/")) {
        ...
        try {
          const analyticsResponse = await fetch(
            `https://api.cloudflare.com/client/v4/zones/${zoneId}/analytics/dashboard?` + new URLSearchParams({
              since,
              until,
              continuous: "true"
            }),
...
// .wrangler/tmp/bundle-r5zoOa/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-r5zoOa/middleware-loader.entry.ts
